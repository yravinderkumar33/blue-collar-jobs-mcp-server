...
router.get('/applications/:application_id', jobsController.getAllApplications);
// 2. View Job Detail
router.get('/:job_id', jobsController.viewJob);
// 3. Apply to a Job
router.post('/:job_id/apply', jobsController.applyToJob);
